...
POSTS = [
  {
    "slug": "smc-trading-journal-guide",
    "tag": "SMC Trading",
    ...
    "read_time": 8,
    "content": """
<p>Most SMC traders spend hours analysing charts but zero minutes reviewing their trades. That's the real reason most don't become consistently profitable — not their setups, but their inability to learn from what they've already done.</p>

<h2>Why Generic Trading Journals Don't Work for SMC Traders</h2>
<p>If you've tried Edgewonk or a spreadsheet to journal your SMC trades, you've probably run into the same problem: there's nowhere to log <strong>why</strong> you took the trade. You can enter price and P&L all day, but without context — "4H FVG tap, 15min MSS confirmation, NY session open" — the data is meaningless.</p>
<p>A good SMC journal needs to capture:</p>
<ul>
  <li>Which setup triggered the entry (Order Block, Fair Value Gap, Liquidity Sweep, etc.)</li>
  <li>Which timeframe the setup was on</li>
  <li>The market structure context (BOS, CHoCH, Premium/Discount)</li>
  <li>Your psychological state at entry</li>
  <li>Session timing (London, New York, Asia)</li>
</ul>

<h2>The 5 Fields Every SMC Trade Journal Entry Needs</h2>

<h3>1. Setup Tag(s)</h3>
<p>Log every concept that contributed to the trade. Not just "Order Block" — be specific. Was it a <em>4H Order Block</em> inside a <em>Daily Premium zone</em> with a <em>Liquidity Sweep</em> above? Log all three. Over 50+ trades you'll see which combinations actually pay you.</p>

<h3>2. Entry Timeframe + Confirmation</h3>
<p>Where did price actually give you entry? "Entered on 1min MSS after tapping 15min FVG" tells you everything. A year from now you'll know whether your 1min confirmations work or whether you should wait for 5min.</p>

<h3>3. Realized R vs Planned R</h3>
<p>Did you take partials at 1R and trail to 3R? Or did you move your stop and get stopped out at -0.5R? Your planned R:R means nothing if you can't execute it. Log both and track the gap.</p>

<h3>4. Session and Time of Day</h3>
<p>XAUUSD behaves completely differently in the Asia session vs NY Open. Logging session lets you discover that 80% of your losses come from trading the wrong time of day — one of the most common findings in trader journals.</p>

<h3>5. Psychology Notes</h3>
<p>This is where most traders skip, and it's the most valuable field. Write 2-3 sentences: what were you thinking at entry? Were you confident or forcing it? Did you feel FOMO? AI can read these notes and detect patterns you can't see yourself.</p>

<h2>How to Review Your SMC Journal Weekly</h2>
<p>Raw data is useless without review. Every week, ask these four questions:</p>
<ol>
  <li><strong>Which setup had the highest win rate?</strong> If Order Blocks win 70% but FVGs win 40%, you know where to focus.</li>
  <li><strong>Which session am I most profitable in?</strong> Most SMC traders are NY traders who keep trying Asia setups.</li>
  <li><strong>What emotion preceded my worst losses?</strong> The answer is almost always frustration or boredom.</li>
  <li><strong>Am I taking my SL where I planned?</strong> Moving stops is the single most common account-killing habit.</li>
</ol>

<h2>Using AI to Find Patterns You Can't See</h2>
<p>The problem with manual journal review is confirmation bias — you unconsciously focus on your wins. AI doesn't have that problem. When you write "I entered this trade even though I wasn't sure about the setup" enough times, an AI pattern analyser will flag it as your costliest behaviour, sorted by dollar damage.</p>
<blockquote>The goal isn't to journal perfectly. The goal is to journal consistently enough that patterns emerge — then act on them.</blockquote>

<h2>Free SMC Trading Journal Template</h2>
<p>TradeJournal is built specifically for SMC traders. It includes all 13 setup tags (Order Block, FVG, BOS, CHoCH, Liquidity Sweep, Breaker Block, Mitigation Block, Inducement, OTE, Imbalance, Premium/Discount, Equal Highs/Lows, Turtle Soup), session tracking, and AI psychology analysis that reads your notes and auto-tags your setups.</p>
<p>It's free, works with MT5 imports, and takes about 3 minutes to log a trade.</p>
"""
  },
  {
    ...
    "read_time": 7,
    "content": """
<p>The dirty secret of prop firm failures: most traders don't blow challenges because of bad setups. They blow them because they forget where they stand on drawdown, or they take one revenge trade on a bad day that breaches the daily loss limit.</p>
<p>A trading journal doesn't just track P&L — it keeps you compliant in real time.</p>

<h2>The 5 Metrics Every Prop Firm Journal Must Track</h2>

<h3>1. Profit Target %</h3>
<p>Most challenges require 8-10% profit. Tracking this as a percentage rather than a dollar amount helps you see progress clearly. If you're at 6.7% on a 10% target, you need 3.3% more — not "$330 on a $10,000 account".</p>

<h3>2. Maximum Drawdown</h3>
<p>This is the hard limit. On most FTMO challenges it's 10% — if your equity drops 10% from the starting balance, you fail. Log every trade and watch this number daily. The worst time to discover you're at 9.5% drawdown is mid-trade.</p>

<h3>3. Daily Drawdown</h3>
<p>Most prop firms have a <em>daily</em> loss limit separate from the max drawdown — typically 5%. This resets at midnight. If you lose 4.9% in the morning, you have $10 of risk left for the rest of the day. Your journal should show this clearly.</p>

<h3>4. Consistency Percentage</h3>
<p>Some firms (including Upcomers) require that no single day's profit exceeds a certain percentage of your total profit. If you made $900 in one trade and $100 across other trades, your consistency score is 90% — which may breach your rules. Tracking this prevents surprises at payout.</p>

<h3>5. Trading Days</h3>
<p>Many challenges require a minimum number of active trading days. Logging every trade date means you always know where you stand without manually counting calendar entries.</p>

<h2>The Revenge Trade Problem</h2>
<p>The number one killer of prop firm challenges is the revenge trade — the oversized position you take after a loss to "make it back quickly." Your journal should track your <strong>risk multiplier</strong>: if your last 10 trades show you risking 2x your normal size, that's a tilt signal and a prop firm red flag.</p>

<h2>Building a Pre-Trade Checklist from Your Journal</h2>
<p>After 20-30 logged trades, your journal data will tell you:</p>
<ul>
  <li>Which sessions you lose money in (avoid those during the challenge)</li>
  <li>Which setups have the highest win rate (only take those)</li>
  <li>What emotional state precedes your losing trades (journal it, then don't trade in that state)</li>
</ul>
<blockquote>A prop firm challenge is not the time to experiment. Use your journal to identify your A+ setups and only trade those for 30 days.</blockquote>

<h2>Real-Time Prop Firm Compliance Dashboard</h2>
<p>TradeJournal includes a live compliance strip that shows your profit target %, max drawdown, daily drawdown, consistency percentage, and ROI — all calculated from your actual trade data. Enter your prop firm's rules in Settings once, and every trade you log automatically updates your compliance status.</p>
"""
  },
  {
    "slug": "xauusd-trading-journal",
    "tag": "XAUUSD",
    ...
    "read_time": 6,
    "content": """
<p>Gold is one of the most traded instruments in the world, but almost every generic trading journal gets the math wrong. The result: your P&L looks right but your R calculations are off, your risk-per-trade is miscalculated, and your performance data is lying to you.</p>

<h2>The XAUUSD Contract Size Problem</h2>
<p>XAUUSD has a <strong>contract size of 100 troy ounces per standard lot</strong>. This means:</p>
<ul>
  <li>1 standard lot (1.0) = 100 oz = $100 per $1 price move</li>
  <li>1 mini lot (0.1) = 10 oz = $10 per $1 price move</li>
  <li>1 micro lot (0.01) = 1 oz = $1 per $1 price move</li>
</ul>
<p>The correct P&L formula is: <code>price_distance × contract_size × lots</code></p>
<p>So if you sold 0.01 lots at 2324.83 and exited at 2329.50, your loss is:</p>
<p><code>(2329.50 - 2324.83) × 100 × 0.01 = 4.67 × 1 = $4.67</code></p>
<p>Many journals use a pip value of $10 or divide by pip size incorrectly, giving you a P&L that's off by a factor of 10. Always verify against your MT5 statement.</p>

<h2>How to Import XAUUSD Trades from MT5</h2>
<p>In MetaTrader 5:</p>
<ol>
  <li>Go to <strong>View → Terminal → Account History</strong></li>
  <li>Right-click → <strong>Save as Detailed Report</strong> (this saves as HTML)</li>
  <li>Import the HTML file into your trading journal</li>
</ol>
<p>A good journal will automatically detect XAUUSD and apply the correct 100 oz/lot contract size, and calculate your commission separately (typically $5 per standard lot on ECN accounts).</p>

<h2>Setting Up R Calculations for Gold</h2>
<p>Your stop loss distance on XAUUSD is usually measured in dollars, not pips. If you enter at 2320 with a stop at 2315, your stop is $5 away. On 0.1 lots, your dollar risk is <code>$5 × 100 × 0.1 = $50</code>.</p>
<p>This means your R multiples are based on dollar risk, not pip risk. Always log:</p>
<ul>
  <li><strong>Entry price</strong> — where you entered</li>
  <li><strong>Stop loss price</strong> — your actual stop, not your mental stop</li>
  <li><strong>Lot size</strong> — exact size taken</li>
</ul>
<p>From these three values, your journal can calculate exact dollar risk and realized R for every trade.</p>

<h2>Common XAUUSD Journaling Mistakes</h2>
<p><strong>1. Not logging the session.</strong> Gold has very different behaviour in the London session vs NY Open. Asian session gold is often choppy and range-bound. Logging session lets you discover where you actually make money.</p>
<p><strong>2. Not tracking news days.</strong> NFP, CPI, and Fed announcements cause extreme XAUUSD moves. If you trade these, flag them. If you don't, make sure your journal shows you're avoiding them.</p>
<p><strong>3. Ignoring spread on small accounts.</strong> On micro lots, a 30-pip spread on gold can eat 30% of a typical trade's profit. Log commission separately to see your true edge.</p>

<blockquote>The best gold traders I've seen all share one habit: they review their last 20 trades before taking the next one. The journal is the edge.</blockquote>
"""
  },
  {
    "slug": "trading-psychology-journal",
    "tag": "Psychology",
    ...
    "read_time": 7,
    "content": """
<p>Every trader knows the feeling: you take a loss, you feel the urge to jump back in immediately to recover it, you size up slightly "just this once," and then you lose more. You know it's wrong while you're doing it. But knowing doesn't stop it.</p>
<p>The solution isn't more discipline. It's data.</p>

<h2>Why Willpower Alone Doesn't Fix Trading Psychology</h2>
<p>Telling yourself "I won't revenge trade" works about as well as telling yourself "I won't eat junk food." Motivation fades, emotions spike, and old patterns win. What actually changes behaviour is seeing the evidence of what those patterns cost you — in dollars, not just feelings.</p>
<p>When you can show yourself: <strong>"Every time I wrote 'frustrated' in my trade notes, my next trade lost an average of $47"</strong> — that's different. That's your own data telling you to stop.</p>

<h2>The 4 Psychology Patterns That Cost Traders Most</h2>

<h3>1. Revenge Trading</h3>
<p>Trading immediately after a loss to recover it. Signs in your journal: trades logged within 30 minutes of a losing trade, larger position sizes after losses, notes containing words like "make it back," "recover," or "just one more."</p>

<h3>2. FOMO Entries</h3>
<p>Entering after a move has already happened because you're afraid of missing it. Signs: entries that aren't at your planned setup level, notes with "missed the move," "chased," or "jumped in late."</p>

<h3>3. Premature Exits</h3>
<p>Closing trades before your target because of fear. Signs: realized R consistently lower than planned R, notes mentioning "got nervous," "took partials too early," or "thought it was reversing."</p>

<h3>4. Overtrading After Wins</h3>
<p>Taking low-quality setups after a winning streak because you feel invincible. Signs: win rate drops on days following 3+ consecutive wins, notes with "felt confident," "took a shot," or "wasn't my best setup."</p>

<h2>How to Write Trade Notes That Actually Reveal Psychology</h2>
<p>Most traders write notes like "entered on OB, hit TP." That's useless for psychology analysis. Write what was happening in your head:</p>
<ul>
  <li>"I wasn't fully confident in this setup but entered anyway because I hadn't traded in 3 days"</li>
  <li>"Price had already moved 20 pips before I entered but I didn't want to miss it"</li>
  <li>"I moved my stop closer because I was nervous, then got stopped out before the move"</li>
  <li>"This was a revenge trade after my morning loss. I knew it as I was clicking"</li>
</ul>
<p>These notes feel uncomfortable to write. That's exactly why they work — the discomfort of documenting a mistake is part of what prevents you from repeating it.</p>

<h2>Using AI to Detect Patterns in Your Psychology Notes</h2>
<p>The limitation of manual journal review is that you're reviewing your own notes with your own biases. AI doesn't have that problem. Feed it 50 trade notes and it will identify:</p>
<ul>
  <li>Which emotional states correlate with losses vs wins</li>
  <li>Which words appear most often before your worst trades</li>
  <li>Whether your discipline score is trending better or worse over time</li>
  <li>The specific behaviour costing you the most money — ranked by dollar damage</li>
</ul>

<h2>The Tilt Indicator: Are You Increasing Risk After Losses?</h2>
<p>One of the most reliable tilt signals is unconsciously increasing position size after losses. You don't plan to do it — it just happens. Track your average dollar risk over your last 10 trades vs your baseline. If it's 1.3x or higher, you're in tilt territory regardless of what you think you're doing.</p>

<blockquote>The journal isn't there to make you feel guilty. It's there to make the invisible visible — so you can fix what your feelings are hiding.</blockquote>

<h2>Building a Psychology Improvement System</h2>
<p>The process is simple, but it requires consistency:</p>
<ol>
  <li><strong>Log every trade with at least 2 sentences of psychology notes</strong></li>
  <li><strong>Review your emotion-to-R chart weekly</strong> — which emotions correlate with wins and losses?</li>
  <li><strong>Identify your #1 pattern</strong> — the behaviour costing you the most money</li>
  <li><strong>Create one concrete rule</strong> — not "be more disciplined," but "no trades for 60 minutes after any loss"</li>
  <li><strong>Track the rule</strong> — did following it improve your results?</li>
</ol>
<p>Over 3 months of consistent journaling, most traders eliminate 1-2 major psychology patterns. The dollar impact is usually larger than any strategy improvement they could make.</p>
"""
  },
]
...
""",
  ...
  {
    "slug": "order-blocks-weak-strong-conditional-smc",
    "tag": "Education",
    "title": "ICT Order Blocks: The Real Reason Some Zones Hold and Others Get Swept",
    "excerpt": "Not every ICT order block holds. Prop firm traders who learn to classify weak, strong and conditional zones before entry stop getting stopped out at the wrong level.",
    "meta_desc": "Discover the real reason some ICT order blocks hold and others get swept. Full breakdown of weak, strong and conditional OBs with diagrams and a five-step pre-entry checklist for funded traders.",
    "seo_title": "ICT Order Blocks: Why Some Hold and Others Get Swept",
    "date": "2026-07-18",
    "read_time": "12 min",
    "content": "<h2>Why SMC Traders Keep Getting Stopped Out at Order Blocks</h2>\n<p>If you trade Smart Money Concepts, you already know what an order block is. You mark the zone, wait for price to return, get a displacement confirmation on the lower timeframe, and enter. Then your stop gets hit. You re-enter from the next block. The stop gets hit again. A few sessions later the market finally moves in your direction, but by then you have already walked away from the setup.</p>\n<p>This pattern is not random. It is the direct result of treating every order block as equally valid. Some order blocks are structurally weak: the market will sweep their liquidity before the real move begins. Others are structurally strong: price respects them on first touch and reverses without hesitation. A third category, the conditional order block, describes situations where an otherwise weak block behaves like the most powerful one on the chart because of the specific market context it forms in.</p>\n\n<h2>The Foundation: No FVG, No Order Block</h2>\n<p>Every valid order block is built from three candles. The candle in the middle must create a Fair Value Gap (FVG) with the candles on either side of it: a gap between candle 1's wick and candle 3's wick where price never traded. Without that gap there is no valid order block, regardless of how the candles look. For a bullish (buy-side) order block, the OB is the down-close candle sitting just below that gap. For a bearish (sell-side) setup, it is the up-close candle sitting just above it.</p>\n<p>This rule does not change between order blocks. What changes is the surrounding structure: the candle colour of the OB candle, where its low sits relative to nearby swing lows, and whether the broader market context triggers a conditional upgrade.</p>\n\n<div style=\"background:#0d1520;border:1px solid #1a2a3a;border-radius:12px;padding:4px;margin:28px 0\">\n<svg viewBox=\"0 0 560 280\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:100%;display:block;font-family:Arial,sans-serif\">\n  <text x=\"280\" y=\"22\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"10\" font-weight=\"700\" letter-spacing=\"1.5\">BULLISH ORDER BLOCK ANATOMY</text>\n  <rect x=\"140\" y=\"108\" width=\"168\" height=\"44\" fill=\"rgba(85,153,255,0.13)\" rx=\"2\"/>\n  <rect x=\"140\" y=\"108\" width=\"168\" height=\"44\" fill=\"none\" stroke=\"#3a66bb\" stroke-width=\"1\" stroke-dasharray=\"4,3\" rx=\"2\"/>\n  <text x=\"224\" y=\"134\" text-anchor=\"middle\" fill=\"#5599ff\" font-size=\"10\" font-weight=\"700\">FAIR VALUE GAP (FVG)</text>\n  <line x1=\"68\" y1=\"62\" x2=\"68\" y2=\"178\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"55\" y=\"74\" width=\"26\" height=\"72\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"112\" y1=\"90\" x2=\"112\" y2=\"200\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"99\" y=\"104\" width=\"26\" height=\"74\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"158\" y1=\"108\" x2=\"158\" y2=\"228\" stroke=\"#ff4757\" stroke-width=\"2.2\"/>\n  <rect x=\"145\" y=\"152\" width=\"26\" height=\"68\" fill=\"#ff4757\" rx=\"2\"/>\n  <rect x=\"94\" y=\"234\" width=\"120\" height=\"26\" fill=\"#1a0808\" stroke=\"#ff4757\" stroke-width=\"1\" rx=\"4\"/>\n  <text x=\"154\" y=\"248\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"9\" font-weight=\"700\">ORDER BLOCK (OB)</text>\n  <text x=\"154\" y=\"258\" text-anchor=\"middle\" fill=\"#667799\" font-size=\"8\">last down candle before move up</text>\n  <line x1=\"154\" y1=\"234\" x2=\"156\" y2=\"220\" stroke=\"#ff4757\" stroke-width=\"0.8\" stroke-dasharray=\"2,2\"/>\n  <line x1=\"215\" y1=\"52\" x2=\"215\" y2=\"188\" stroke=\"#00c880\" stroke-width=\"2\"/>\n  <rect x=\"202\" y=\"55\" width=\"26\" height=\"105\" fill=\"#00c880\" rx=\"2\"/>\n  <line x1=\"260\" y1=\"40\" x2=\"260\" y2=\"118\" stroke=\"#00c880\" stroke-width=\"1.8\"/>\n  <rect x=\"247\" y=\"44\" width=\"26\" height=\"60\" fill=\"#00c880\" rx=\"1\"/>\n  <rect x=\"186\" y=\"234\" width=\"100\" height=\"26\" fill=\"#081a10\" stroke=\"#00c880\" stroke-width=\"1\" rx=\"4\"/>\n  <text x=\"236\" y=\"248\" text-anchor=\"middle\" fill=\"#00c880\" font-size=\"9\" font-weight=\"700\">DISPLACEMENT</text>\n  <text x=\"236\" y=\"258\" text-anchor=\"middle\" fill=\"#667799\" font-size=\"8\">fast move creating FVG</text>\n  <line x1=\"302\" y1=\"36\" x2=\"302\" y2=\"90\" stroke=\"#5599ff\" stroke-width=\"1.5\"/>\n  <rect x=\"289\" y=\"40\" width=\"26\" height=\"38\" fill=\"#2a5ab0\" rx=\"1\"/>\n  <path d=\"M335 58 C400 50, 440 48, 450 100 C460 160, 430 230, 360 248 C310 258, 250 258, 210 248\" stroke=\"#ffd700\" stroke-width=\"1.5\" fill=\"none\" stroke-dasharray=\"6,4\"/>\n  <polygon points=\"205,243 207,253 214,246\" fill=\"#ffd700\"/>\n  <text x=\"460\" y=\"78\" fill=\"#ffd700\" font-size=\"10\" text-anchor=\"middle\" font-weight=\"700\">Price</text>\n  <text x=\"460\" y=\"92\" fill=\"#ffd700\" font-size=\"10\" text-anchor=\"middle\">returns</text>\n  <text x=\"460\" y=\"106\" fill=\"#ffd700\" font-size=\"10\" text-anchor=\"middle\">to OB</text>\n  <text x=\"460\" y=\"120\" fill=\"#ffd700\" font-size=\"10\" text-anchor=\"middle\">bounces</text>\n</svg>\n</div>\n\n<h2>The Five Structural Types</h2>\n<p>With the FVG held constant, there are five ways the surrounding structure of an order block can differ. Types 1 and 2 examine the candle colour of the OB candle relative to the direction of the move. Types 3 through 5 look at where the order block's low sits relative to the most recent swing low.</p>\n\n<div style=\"overflow-x:auto;margin:20px 0\">\n<table style=\"width:100%;border-collapse:collapse;font-size:13px\">\n<thead><tr style=\"background:#111a28\">\n<th style=\"padding:10px 14px;text-align:center;border-bottom:1px solid #1e2d3d;color:#5a6a8a;font-size:10px;letter-spacing:1px;width:44px\">TYPE</th>\n<th style=\"padding:10px 14px;text-align:left;border-bottom:1px solid #1e2d3d;color:#5a6a8a;font-size:10px;letter-spacing:1px\">WHAT TO CHECK</th>\n<th style=\"padding:10px 14px;text-align:left;border-bottom:1px solid #1e2d3d;color:#5a6a8a;font-size:10px;letter-spacing:1px\">CLASSIFICATION</th>\n</tr></thead>\n<tbody>\n<tr style=\"border-bottom:1px solid #111a28\">\n<td style=\"padding:10px 14px;text-align:center;color:#e8edf5;font-weight:700\">1</td>\n<td style=\"padding:10px 14px;color:#8b95b3\">OB candle colour matches the direction of the move (e.g. green candle in a bullish move)</td>\n<td style=\"padding:10px 14px\"><span style=\"color:#ff4757;font-weight:700\">WEAK</span></td>\n</tr>\n<tr style=\"background:#0a1520;border-bottom:1px solid #111a28\">\n<td style=\"padding:10px 14px;text-align:center;color:#e8edf5;font-weight:700\">2</td>\n<td style=\"padding:10px 14px;color:#8b95b3\">OB candle colour opposes the direction of the move (e.g. red candle in a bullish move)</td>\n<td style=\"padding:10px 14px\"><span style=\"color:#00e5a0;font-weight:700\">STRONG</span></td>\n</tr>\n<tr style=\"border-bottom:1px solid #111a28\">\n<td style=\"padding:10px 14px;text-align:center;color:#e8edf5;font-weight:700\">3</td>\n<td style=\"padding:10px 14px;color:#8b95b3\">The FVG candle (middle one), not the OB candle, marks the structural extreme of the formation</td>\n<td style=\"padding:10px 14px\"><span style=\"color:#ff4757;font-weight:700\">WEAK</span></td>\n</tr>\n<tr style=\"background:#0a1520;border-bottom:1px solid #111a28\">\n<td style=\"padding:10px 14px;text-align:center;color:#e8edf5;font-weight:700\">4</td>\n<td style=\"padding:10px 14px;color:#8b95b3\">OB low aligns exactly with the most recent swing low (check candle colour too: opposite colour here = \"strong with colour\")</td>\n<td style=\"padding:10px 14px\"><span style=\"color:#8b95b3;font-weight:700\">NEUTRAL</span> to <span style=\"color:#00e5a0;font-weight:700\">STRONG</span></td>\n</tr>\n<tr>\n<td style=\"padding:10px 14px;text-align:center;color:#e8edf5;font-weight:700\">5</td>\n<td style=\"padding:10px 14px;color:#8b95b3\">OB sits above the most recent swing low (the real structural low is a separate, lower point)</td>\n<td style=\"padding:10px 14px\"><span style=\"color:#ff4757;font-weight:700\">WEAK</span></td>\n</tr>\n</tbody>\n</table>\n</div>\n\n<div style=\"background:#0d1520;border:1px solid #1a2a3a;border-radius:12px;padding:4px;margin:28px 0\">\n<svg viewBox=\"0 0 560 260\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:100%;display:block;font-family:Arial,sans-serif\">\n  <line x1=\"280\" y1=\"10\" x2=\"280\" y2=\"250\" stroke=\"#1e2d3d\" stroke-width=\"1\"/>\n  <text x=\"140\" y=\"22\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"10\" font-weight=\"700\" letter-spacing=\"1\">WEAK ORDER BLOCK</text>\n  <text x=\"420\" y=\"22\" text-anchor=\"middle\" fill=\"#00e5a0\" font-size=\"10\" font-weight=\"700\" letter-spacing=\"1\">STRONG ORDER BLOCK</text>\n  <text x=\"140\" y=\"36\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"9\">OB candle = same colour as move</text>\n  <text x=\"420\" y=\"36\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"9\">OB candle = opposite colour</text>\n  <line x1=\"45\" y1=\"58\" x2=\"45\" y2=\"156\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"33\" y=\"68\" width=\"24\" height=\"60\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"85\" y1=\"80\" x2=\"85\" y2=\"176\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"73\" y=\"92\" width=\"24\" height=\"66\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"130\" y1=\"140\" x2=\"130\" y2=\"206\" stroke=\"#00c880\" stroke-width=\"2.2\"/>\n  <rect x=\"118\" y=\"152\" width=\"24\" height=\"44\" fill=\"#00c880\" rx=\"2\"/>\n  <rect x=\"109\" y=\"188\" width=\"42\" height=\"18\" fill=\"#0a1c10\" stroke=\"#00c880\" stroke-width=\"1\" rx=\"3\"/>\n  <text x=\"130\" y=\"200\" text-anchor=\"middle\" fill=\"#00c880\" font-size=\"8\" font-weight=\"700\">WEAK OB</text>\n  <line x1=\"185\" y1=\"65\" x2=\"185\" y2=\"175\" stroke=\"#00c880\" stroke-width=\"2\"/>\n  <rect x=\"173\" y=\"68\" width=\"24\" height=\"88\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"230\" y1=\"50\" x2=\"230\" y2=\"120\" stroke=\"#00c880\" stroke-width=\"1.5\"/>\n  <rect x=\"218\" y=\"54\" width=\"24\" height=\"52\" fill=\"#00c880\" rx=\"1\"/>\n  <path d=\"M128 152 C128 130, 120 115, 100 110\" stroke=\"#ff4757\" stroke-width=\"1.2\" fill=\"none\" stroke-dasharray=\"4,3\"/>\n  <polygon points=\"95,107 102,116 109,108\" fill=\"#ff4757\"/>\n  <text x=\"60\" y=\"118\" fill=\"#ff4757\" font-size=\"8\" text-anchor=\"middle\">sweep</text>\n  <text x=\"60\" y=\"128\" fill=\"#ff4757\" font-size=\"8\" text-anchor=\"middle\">expected</text>\n  <line x1=\"325\" y1=\"58\" x2=\"325\" y2=\"156\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"313\" y=\"68\" width=\"24\" height=\"60\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"365\" y1=\"80\" x2=\"365\" y2=\"176\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"353\" y=\"92\" width=\"24\" height=\"66\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"410\" y1=\"118\" x2=\"410\" y2=\"208\" stroke=\"#ff4757\" stroke-width=\"2.2\"/>\n  <rect x=\"398\" y=\"140\" width=\"24\" height=\"60\" fill=\"#ff4757\" rx=\"2\"/>\n  <rect x=\"389\" y=\"188\" width=\"42\" height=\"18\" fill=\"#1a0808\" stroke=\"#ff4757\" stroke-width=\"1\" rx=\"3\"/>\n  <text x=\"410\" y=\"200\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"8\" font-weight=\"700\">STRONG OB</text>\n  <line x1=\"465\" y1=\"50\" x2=\"465\" y2=\"165\" stroke=\"#00c880\" stroke-width=\"2\"/>\n  <rect x=\"453\" y=\"53\" width=\"24\" height=\"100\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"510\" y1=\"38\" x2=\"510\" y2=\"112\" stroke=\"#00c880\" stroke-width=\"1.5\"/>\n  <rect x=\"498\" y=\"42\" width=\"24\" height=\"58\" fill=\"#00c880\" rx=\"1\"/>\n  <path d=\"M410 140 C410 120, 418 105, 435 100\" stroke=\"#00e5a0\" stroke-width=\"1.2\" fill=\"none\"/>\n  <polygon points=\"440,97 434,105 442,107\" fill=\"#00e5a0\"/>\n  <text x=\"450\" y=\"105\" fill=\"#00e5a0\" font-size=\"8\" text-anchor=\"middle\">respects</text>\n  <text x=\"450\" y=\"115\" fill=\"#00e5a0\" font-size=\"8\" text-anchor=\"middle\">first touch</text>\n  <text x=\"140\" y=\"240\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"9\">Liquidity likely swept before real move</text>\n  <text x=\"420\" y=\"240\" text-anchor=\"middle\" fill=\"#00e5a0\" font-size=\"9\">Reversal expected on first touch</text>\n</svg>\n</div>\n\n<p>The strongest version of a structure-based order block combines both criteria: the OB's low aligns exactly with the most recent swing low AND the OB candle colour opposes the move's direction. This is called \"strong with colour\" and represents the highest-confidence entry without any conditional context.</p>\n\n<h2>What the Classification Predicts</h2>\n<p>A weak order block predicts that the market will wick through it or trade through the FVG entirely before continuing in your direction. You can still trade from a weak order block, but your stop must sit above the expected sweep, not tight below the block's low. The alternative is to skip the weak block entirely and wait for the next valid one that classifies as strong.</p>\n<p>A strong order block predicts that price will respect it on first touch and reverse without taking liquidity first. Stop goes below the structural low, tight. This is a fundamentally different trade from a size, risk, and management standpoint.</p>\n<p>The classification does not tell you whether the market will go in your bias direction. It tells you which specific order block along that path to trust, and which one is going to trap you before the real move begins.</p>\n\n<h2>The Trap: Trading Without This Filter</h2>\n<p>Replay any multi-day stretch of price action and mark every order block as equally valid. The pattern is consistent: a block forms, price taps it, a 15-minute displacement confirms the direction, and the stop gets hit anyway. This repeats across seven to ten trading days. By the point the real move finally starts, most traders have taken two or three losses and stopped trusting the approach.</p>\n<p>Apply the classification before price arrives and the same stretch looks entirely different. Weak blocks get their liquidity swept as expected. Strong blocks get respected and price reverses from them without hesitation. The outcome was predictable each time.</p>\n\n<h2>Conditional Upgrade #1: Liquidity Sweep and Break of Structure</h2>\n<p>Not every weak order block stays weak. The first conditional upgrade applies when two things happen in the same market leg: price sweeps the liquidity of a prior swing (a wick beyond the swing point with no candle close beyond it), and then breaks structure in your bias direction. Any order block that forms inside that leg is upgraded to \"Strongest OB\" regardless of which of the five weak patterns it technically matches.</p>\n\n<div style=\"background:#0d1520;border:1px solid #1a2a3a;border-radius:12px;padding:4px;margin:28px 0\">\n<svg viewBox=\"0 0 560 240\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:100%;display:block;font-family:Arial,sans-serif\">\n  <text x=\"280\" y=\"22\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"10\" font-weight=\"700\" letter-spacing=\"1.5\">CONDITIONAL OB: LIQUIDITY SWEEP + BREAK OF STRUCTURE</text>\n  <line x1=\"40\" y1=\"88\" x2=\"520\" y2=\"88\" stroke=\"#2a4a6a\" stroke-width=\"1\" stroke-dasharray=\"5,4\"/>\n  <text x=\"525\" y=\"92\" fill=\"#3a6a9a\" font-size=\"8\" text-anchor=\"start\">Swing</text>\n  <text x=\"525\" y=\"102\" fill=\"#3a6a9a\" font-size=\"8\" text-anchor=\"start\">High</text>\n  <line x1=\"68\" y1=\"118\" x2=\"68\" y2=\"196\" stroke=\"#8b95b3\" stroke-width=\"1.5\"/>\n  <rect x=\"56\" y=\"128\" width=\"24\" height=\"50\" fill=\"#2a4060\" rx=\"1\"/>\n  <line x1=\"108\" y1=\"100\" x2=\"108\" y2=\"196\" stroke=\"#8b95b3\" stroke-width=\"1.5\"/>\n  <rect x=\"96\" y=\"112\" width=\"24\" height=\"66\" fill=\"#2a4060\" rx=\"1\"/>\n  <line x1=\"152\" y1=\"98\" x2=\"152\" y2=\"200\" stroke=\"#8b95b3\" stroke-width=\"1.5\"/>\n  <rect x=\"140\" y=\"110\" width=\"24\" height=\"72\" fill=\"#2a4060\" rx=\"1\"/>\n  <line x1=\"198\" y1=\"60\" x2=\"198\" y2=\"196\" stroke=\"#ffd700\" stroke-width=\"2\"/>\n  <rect x=\"186\" y=\"92\" width=\"24\" height=\"86\" fill=\"#3a3010\" stroke=\"#ffd700\" stroke-width=\"1\" rx=\"1\"/>\n  <text x=\"198\" y=\"52\" text-anchor=\"middle\" fill=\"#ffd700\" font-size=\"8\" font-weight=\"700\">SWEEP</text>\n  <polygon points=\"198,60 194,72 202,72\" fill=\"#ffd700\"/>\n  <rect x=\"172\" y=\"106\" width=\"52\" height=\"32\" fill=\"rgba(0,229,160,0.12)\" stroke=\"#00b37a\" stroke-width=\"1\" stroke-dasharray=\"3,2\" rx=\"3\"/>\n  <text x=\"198\" y=\"120\" text-anchor=\"middle\" fill=\"#00e5a0\" font-size=\"8\" font-weight=\"700\">OB ZONE</text>\n  <text x=\"198\" y=\"132\" text-anchor=\"middle\" fill=\"#00e5a0\" font-size=\"7\">strongest OB</text>\n  <line x1=\"242\" y1=\"108\" x2=\"242\" y2=\"200\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"230\" y=\"120\" width=\"24\" height=\"62\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"286\" y1=\"130\" x2=\"286\" y2=\"210\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"274\" y=\"142\" width=\"24\" height=\"60\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"310\" y1=\"155\" x2=\"360\" y2=\"155\" stroke=\"#ff4757\" stroke-width=\"1.5\" marker-end=\"url(#arrowRed)\"/>\n  <text x=\"335\" y=\"170\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"8\" font-weight=\"700\">BOS</text>\n  <text x=\"335\" y=\"180\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"7\">break of structure</text>\n  <line x1=\"375\" y1=\"195\" x2=\"375\" y2=\"108\" stroke=\"#00c880\" stroke-width=\"2\"/>\n  <rect x=\"363\" y=\"110\" width=\"24\" height=\"76\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"420\" y1=\"148\" x2=\"420\" y2=\"72\" stroke=\"#00c880\" stroke-width=\"2\"/>\n  <rect x=\"408\" y=\"75\" width=\"24\" height=\"62\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"465\" y1=\"115\" x2=\"465\" y2=\"60\" stroke=\"#00c880\" stroke-width=\"1.5\"/>\n  <rect x=\"453\" y=\"63\" width=\"24\" height=\"44\" fill=\"#00c880\" rx=\"1\"/>\n  <rect x=\"170\" y=\"200\" width=\"56\" height=\"28\" fill=\"#081a10\" stroke=\"#00e5a0\" stroke-width=\"1.2\" rx=\"4\"/>\n  <text x=\"198\" y=\"213\" text-anchor=\"middle\" fill=\"#00e5a0\" font-size=\"8\" font-weight=\"700\">STRONGEST</text>\n  <text x=\"198\" y=\"223\" text-anchor=\"middle\" fill=\"#00e5a0\" font-size=\"8\" font-weight=\"700\">OB</text>\n  <defs><marker id=\"arrowRed\" markerWidth=\"7\" markerHeight=\"7\" refX=\"5\" refY=\"3.5\" orient=\"auto\"><polygon points=\"0 0, 7 3.5, 0 7\" fill=\"#ff4757\"/></marker></defs>\n</svg>\n</div>\n\n<p>The logic is direct. A liquidity sweep followed by a break of structure means the market collected the orders it needed to drive a real move. The order block inside that leg carries those orders behind it. Candle colour and swing position become secondary to this context. In practice: identify a prior swing, watch for a wick beyond it with no candle close beyond it, confirm a break of structure in your direction, and mark the order block inside that leg as your entry target.</p>\n\n<h2>Conditional Upgrade #2: Inducement (IDM)</h2>\n<p>The second conditional upgrade is structural. After a break of structure, the first minor swing that forms in the opposing direction is called the inducement, or IDM. It exists because the market needs to collect one more pool of liquidity before continuing. Price will sweep the IDM before the real continuation move starts.</p>\n\n<div style=\"background:#0d1520;border:1px solid #1a2a3a;border-radius:12px;padding:4px;margin:28px 0\">\n<svg viewBox=\"0 0 560 285\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:100%;display:block;font-family:Arial,sans-serif\">\n  <text x=\"280\" y=\"19\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"10\" font-weight=\"700\" letter-spacing=\"1.5\">CONDITIONAL OB: INDUCEMENT (IDM)</text>\n  <line x1=\"30\" y1=\"148\" x2=\"422\" y2=\"148\" stroke=\"#3a5a8a\" stroke-width=\"1\" stroke-dasharray=\"5,4\" opacity=\"0.7\"/>\n  <text x=\"5\" y=\"145\" fill=\"#3a6a9a\" font-size=\"7\" font-weight=\"700\">SWING</text>\n  <text x=\"5\" y=\"155\" fill=\"#3a6a9a\" font-size=\"7\" font-weight=\"700\">LOW</text>\n  <line x1=\"55\" y1=\"60\" x2=\"55\" y2=\"100\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"43\" y=\"67\" width=\"24\" height=\"26\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"99\" y1=\"78\" x2=\"99\" y2=\"120\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"87\" y=\"85\" width=\"24\" height=\"28\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"143\" y1=\"108\" x2=\"143\" y2=\"228\" stroke=\"#ff4757\" stroke-width=\"2.5\"/>\n  <rect x=\"131\" y=\"114\" width=\"24\" height=\"106\" fill=\"#ff4757\" rx=\"2\"/>\n  <rect x=\"151\" y=\"143\" width=\"40\" height=\"20\" fill=\"#180000\" stroke=\"#ff4757\" stroke-width=\"1\" rx=\"3\"/>\n  <text x=\"171\" y=\"156\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"9\" font-weight=\"700\">BOS</text>\n  <line x1=\"188\" y1=\"200\" x2=\"188\" y2=\"230\" stroke=\"#00c880\" stroke-width=\"1.5\"/>\n  <rect x=\"176\" y=\"207\" width=\"24\" height=\"17\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"232\" y1=\"157\" x2=\"232\" y2=\"214\" stroke=\"#00c880\" stroke-width=\"1.8\"/>\n  <rect x=\"220\" y=\"165\" width=\"24\" height=\"42\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"276\" y1=\"84\" x2=\"276\" y2=\"164\" stroke=\"#00c880\" stroke-width=\"2\"/>\n  <rect x=\"264\" y=\"92\" width=\"24\" height=\"62\" fill=\"#00c880\" rx=\"2\"/>\n  <circle cx=\"276\" cy=\"82\" r=\"7\" fill=\"none\" stroke=\"#ffd700\" stroke-width=\"2\"/>\n  <text x=\"276\" y=\"59\" text-anchor=\"middle\" fill=\"#ffd700\" font-size=\"8.5\" font-weight=\"700\">IDM HIGH</text>\n  <text x=\"276\" y=\"70\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"7.5\">(inducement)</text>\n  <rect x=\"254\" y=\"88\" width=\"50\" height=\"70\" fill=\"rgba(255,152,0,0.12)\" stroke=\"#ff9800\" stroke-width=\"1.6\" stroke-dasharray=\"4,3\" rx=\"3\"/>\n  <text x=\"279\" y=\"172\" text-anchor=\"middle\" fill=\"#ff9800\" font-size=\"8\" font-weight=\"700\">STRONGEST OB</text>\n  <line x1=\"304\" y1=\"88\" x2=\"450\" y2=\"88\" stroke=\"#ff9800\" stroke-width=\"0.8\" stroke-dasharray=\"4,4\" opacity=\"0.4\"/>\n  <line x1=\"304\" y1=\"158\" x2=\"450\" y2=\"158\" stroke=\"#ff9800\" stroke-width=\"0.8\" stroke-dasharray=\"4,4\" opacity=\"0.4\"/>\n  <line x1=\"318\" y1=\"110\" x2=\"318\" y2=\"198\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"306\" y=\"118\" width=\"24\" height=\"72\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"362\" y1=\"144\" x2=\"362\" y2=\"210\" stroke=\"#c03a3a\" stroke-width=\"1.5\"/>\n  <rect x=\"350\" y=\"152\" width=\"24\" height=\"50\" fill=\"#c03a3a\" rx=\"1\"/>\n  <line x1=\"406\" y1=\"100\" x2=\"406\" y2=\"205\" stroke=\"#00c880\" stroke-width=\"1.8\"/>\n  <rect x=\"394\" y=\"108\" width=\"24\" height=\"90\" fill=\"#00c880\" rx=\"1\"/>\n  <line x1=\"450\" y1=\"78\" x2=\"450\" y2=\"206\" stroke=\"#ff4757\" stroke-width=\"2.5\"/>\n  <rect x=\"438\" y=\"94\" width=\"24\" height=\"100\" fill=\"#ff4757\" rx=\"2\"/>\n  <line x1=\"494\" y1=\"164\" x2=\"494\" y2=\"258\" stroke=\"#c03a3a\" stroke-width=\"1.8\"/>\n  <rect x=\"482\" y=\"172\" width=\"24\" height=\"78\" fill=\"#c03a3a\" rx=\"1\"/>\n  <rect x=\"422\" y=\"36\" width=\"126\" height=\"30\" fill=\"#180000\" stroke=\"#ff4757\" stroke-width=\"1.2\" rx=\"4\"/>\n  <text x=\"485\" y=\"50\" text-anchor=\"middle\" fill=\"#ff4757\" font-size=\"9\" font-weight=\"700\">SELL FROM OB</text>\n  <text x=\"485\" y=\"61\" text-anchor=\"middle\" fill=\"#5a6a8a\" font-size=\"7.5\">IDM liquidity collected</text>\n  <line x1=\"455\" y1=\"66\" x2=\"451\" y2=\"79\" stroke=\"#ff4757\" stroke-width=\"0.8\" stroke-dasharray=\"2,2\"/>\n  <line x1=\"165\" y1=\"258\" x2=\"165\" y2=\"266\" stroke=\"#2a3a4a\" stroke-width=\"0.8\"/>\n  <line x1=\"298\" y1=\"258\" x2=\"298\" y2=\"266\" stroke=\"#2a3a4a\" stroke-width=\"0.8\"/>\n  <line x1=\"386\" y1=\"258\" x2=\"386\" y2=\"266\" stroke=\"#2a3a4a\" stroke-width=\"0.8\"/>\n  <line x1=\"430\" y1=\"258\" x2=\"430\" y2=\"266\" stroke=\"#2a3a4a\" stroke-width=\"0.8\"/>\n  <text x=\"90\" y=\"278\" text-anchor=\"middle\" fill=\"#3a4a62\" font-size=\"8\">1 BOS BREAKS STRUCTURE</text>\n  <text x=\"228\" y=\"278\" text-anchor=\"middle\" fill=\"#3a4a62\" font-size=\"8\">2 IDM BOUNCE draws in buyers</text>\n  <text x=\"338\" y=\"278\" text-anchor=\"middle\" fill=\"#3a4a62\" font-size=\"8\">3 PULL BACK</text>\n  <text x=\"468\" y=\"278\" text-anchor=\"middle\" fill=\"#3a4a62\" font-size=\"8\">4 OB TAP - sell continuation</text>\n</svg>\n</div>\n\n<p>An order block sitting just after the IDM point is upgraded to \"Strongest OB\" because by the time price returns to that block, the IDM liquidity has already been collected. There is no structural reason left for the market to push past the block before continuing in trend direction. This conditional applies even to a plain Type 1 weak order block where candle colour alone would classify it as weak. The context overrides the classification entirely.</p>\n\n<h2>Reading Order Blocks Across Timeframes</h2>\n<p>The weak/strong/conditional framework applies identically on every timeframe. The practical workflow is top-down: identify a point of interest (POI) on a higher timeframe (weekly or daily), treat the opposing liquidity as the target, then step down through 4-hour, 1-hour, and 15-minute charts to time the entry. At each timeframe, apply the same classification to every order block you encounter.</p>\n<p>A weekly POI can take days to resolve. That is expected behaviour, not failure. The classification tells you which block at each step down to anchor your stop-loss to, and whether to plan for a sweep before the continuation or an immediate reversal from first touch. The highest-conviction entries come from stacking the signal across timeframes: a strong order block on the 4-hour inside a conditional OB zone on the 1-hour, inside a daily POI, all showing the same directional bias.</p>\n\n<h2>Classification Checklist</h2>\n<p>Before entering any order block trade, work through these steps in order. Do not move to the next step until the current one passes.</p>\n<div style=\"background:#0a1520;border:1px solid #1a2a3a;border-radius:10px;overflow:hidden;margin-top:20px\">\n<table style=\"width:100%;border-collapse:collapse;font-size:13px\">\n<tbody>\n<tr style=\"border-bottom:1px solid #111a28\">\n<td style=\"padding:12px 16px;color:#00e5a0;font-weight:700;white-space:nowrap;font-size:14px;width:32px\">1</td>\n<td style=\"padding:12px 16px;color:#e8edf5;font-weight:700\">Confirm the FVG</td>\n<td style=\"padding:12px 16px;color:#8b95b3\">Gap between candle 1's wick and candle 3's wick. No FVG = no order block, skip it entirely.</td>\n</tr>\n<tr style=\"border-bottom:1px solid #111a28;background:#0d1117\">\n<td style=\"padding:12px 16px;color:#00e5a0;font-weight:700;font-size:14px\">2</td>\n<td style=\"padding:12px 16px;color:#e8edf5;font-weight:700\">Check OB candle colour</td>\n<td style=\"padding:12px 16px;color:#8b95b3\">Same colour as the move direction = weak. Opposite colour = strong. Note the classification before going further.</td>\n</tr>\n<tr style=\"border-bottom:1px solid #111a28\">\n<td style=\"padding:12px 16px;color:#00e5a0;font-weight:700;font-size:14px\">3</td>\n<td style=\"padding:12px 16px;color:#e8edf5;font-weight:700\">Check structural position</td>\n<td style=\"padding:12px 16px;color:#8b95b3\">Is the OB low at the swing low (strong), above it (weak), or is the FVG candle setting the extreme instead of the OB candle (weak)?</td>\n</tr>\n<tr style=\"border-bottom:1px solid #111a28;background:#0d1117\">\n<td style=\"padding:12px 16px;color:#ffd700;font-weight:700;font-size:14px\">4</td>\n<td style=\"padding:12px 16px;color:#e8edf5;font-weight:700\">Apply conditional checks</td>\n<td style=\"padding:12px 16px;color:#8b95b3\">Did the leg contain a liquidity sweep followed by a BOS? Does the OB sit just after an IDM point? Either condition upgrades any classification to Strongest OB.</td>\n</tr>\n<tr>\n<td style=\"padding:12px 16px;color:#00e5a0;font-weight:700;font-size:14px\">5</td>\n<td style=\"padding:12px 16px;color:#e8edf5;font-weight:700\">Size your stop to the result</td>\n<td style=\"padding:12px 16px;color:#8b95b3\">Strong or conditional: stop below the structural low, tight. Weak: widen the stop above the expected sweep, or skip the trade and wait for the next block.</td>\n</tr>\n</tbody>\n</table>\n</div>",
    "faq": [
    {
        "q": "What is the difference between a weak and a strong order block in SMC?",
        "a": "A weak order block has its OB candle matching the direction of the overall move (e.g. a green candle inside a bullish move). A strong order block has the OB candle opposing the direction (a red candle inside a bullish move). Weak blocks are likely to have their liquidity swept before the real move continues. Strong blocks tend to be respected on first touch, giving a tighter stop-loss entry."
    },
    {
        "q": "Can a weak order block become a strong conditional order block?",
        "a": "Yes. This is exactly what the conditional order block framework describes. If a liquidity sweep of a prior swing followed by a break of structure occurs in the same leg as the order block, that OB is upgraded to the strongest classification regardless of its original type. The same upgrade applies when the order block sits just after an inducement (IDM) point. Context overrides candle colour and structural position in both cases."
    },
    {
        "q": "What is a Fair Value Gap and why is it required for every order block?",
        "a": "A Fair Value Gap (FVG) is a price imbalance created when the wick of candle 1 and the wick of candle 3 in a three-candle sequence do not overlap, leaving an untraded zone in between. Without this gap there is no valid order block. The FVG is the non-negotiable foundation of every order block regardless of type, candle colour, or market context."
    },
    {
        "q": "What is an inducement (IDM) in Smart Money Concepts trading?",
        "a": "The inducement (IDM) is the first minor swing that forms in the opposing direction after a break of structure. It acts as a temporary liquidity target that price sweeps before the real continuation begins. An order block that sits just after the IDM is classified as Strongest OB because by the time price returns to that block, the IDM liquidity has already been collected and there is no structural reason left to prevent the block from holding."
    },
    {
        "q": "How do I apply order block classification across multiple timeframes?",
        "a": "Start on a higher timeframe (weekly or daily) to identify a point of interest (POI). Treat the opposing liquidity as your target. Step down through 4-hour, 1-hour, and 15-minute charts, applying the same weak/strong/conditional classification at each level to time your entry. The highest-conviction setups occur when a strong or conditional order block on the lower timeframe aligns with a higher-timeframe POI and both timeframes show the same directional bias."
    },
    {
        "q": "Why does order block classification matter specifically for prop firm challenges?",
        "a": "In a prop firm challenge, every loss counts toward a daily or overall drawdown limit. Trading from a weak order block that is likely to get swept before the real move means you are risking a rule violation on a setup with a known structural flaw. Using the classification framework before entering means you skip high-risk blocks entirely or widen your stop to account for the expected sweep, which keeps losses within prop firm parameters. Strong and conditional blocks allow tight stops below the structural low, giving a better risk-to-reward ratio that is essential for passing funded account evaluations efficiently."
    }
],
    "howto": {
    "name": "How to Classify an Order Block as Weak, Strong, or Conditional",
    "description": "A five-step checklist for applying the weak/strong/conditional order block framework to any SMC setup before entering a trade.",
    "steps": [
        {
            "name": "Confirm the Fair Value Gap",
            "text": "Verify there is a clear gap between candle 1's wick and candle 3's wick in the three-candle formation. If no FVG exists, the zone is not a valid order block regardless of how the candles look. Do not proceed to the next step without confirming this."
        },
        {
            "name": "Check OB candle colour relative to the move",
            "text": "If the OB candle's colour matches the direction of the displacement move (e.g. a green OB candle in a bullish move), classify the block as weak. If the OB candle colour opposes the move (e.g. a red OB candle in a bullish move), classify it as strong."
        },
        {
            "name": "Check structural position relative to the swing low",
            "text": "Determine whether the OB's low aligns exactly with the most recent swing low (strong or neutral), sits above it (weak), or whether the FVG candle sets the structural extreme instead of the OB candle (weak). The OB at the swing low combined with opposite-colour candle is the strongest structure-based classification."
        },
        {
            "name": "Apply the two conditional checks",
            "text": "Check whether a liquidity sweep of a prior swing followed by a break of structure occurred in the same leg. Also check whether the OB sits just after an inducement (IDM) point. Either condition upgrades the block to Strongest OB regardless of the original classification from steps 2 and 3."
        },
        {
            "name": "Set stop-loss based on the final classification",
            "text": "For a strong or conditional OB, place your stop below the structural low of the order block. For a weak OB, either skip the trade and wait for the next valid block, or widen the stop above the expected liquidity sweep. Never use a fixed pip stop on order blocks: the classification determines the stop placement."
        }
    ]
}
  }
